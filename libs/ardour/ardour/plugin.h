...
class LIBARDOUR_API PluginInfo {
  public:
	...
	//NOTE: it is possible for a plugin to be an effect AND an instrument.  override these funcs as necessary to support that. 
	bool is_effect () const;
	bool is_instrument () const;
	bool is_utility () const;  //this includes things like "generators" and "midi filters"
